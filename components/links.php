...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 max-w-7xl mx-auto p-8 rounded-xl">
  ...
  <div class="space-y-6">
    ...
    <div class="space-y-4">
      <div class="flex items-center gap-3 p-3 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm transition duration-300 border border-white/20">
  ...
  <div class="space-y-6">
    ...
    <div class="space-y-3">
      <a href="https://www.instagram.com/nexarc_rise/" target="_blank"
         class="flex items-center gap-3 p-3 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm transition duration-300 group border border-white/20">
  ...
  <div class="space-y-6">
    ...
    <ul class="space-y-3">
      <li>
        <a href="/privacy-policy" class="flex items-center gap-2 p-3 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm transition duration-300 group border border-white/20">
          <div class="w-2 h-2 grad_secondary rounded-full"></div>
          <span class="group-hover:underline gradient-text">Privacy Policy</span>
        </a>
      </li>
      <li>
        <a href="/terms-of-service" class="flex items-center gap-2 p-3 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm transition duration-300 group border border-white/20">
          <div class="w-2 h-2 grad_secondary rounded-full"></div>
          <span class="group-hover:underline gradient-text">Terms of Service</span>
        </a>
      </li>
      <li>
        <a href="/contact" class="flex items-center gap-2 p-3 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm transition duration-300 group border border-white/20">
          <div class="w-2 h-2 grad_secondary rounded-full"></div>

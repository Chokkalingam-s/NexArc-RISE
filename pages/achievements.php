...
<section class="grid md:grid-cols-2 gap-4 min-h-screen">
  <!-- Conferences Section -->
  <div class="<?= empty($conferences) ? 'hidden' : 'space-y-6 relative z-10' ?>">
          ...
          <div class="relative z-10">
            <div class="flex justify-between items-start">
              ...
              <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-blue-800 font-medium"><?= htmlspecialchars($conf["status"]) ?></span>
              </div>
            </div>
            ...
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-2">
                ...
                <span class="text-slate-600 text-sm"><?= htmlspecialchars($conf["year_of_end"]) ?></span>
              </div>
  ...
  <!-- Journals Section -->
  <div class="<?= empty($journals) ? 'hidden' : 'space-y-6 relative z-10' ?>">
    <div class="c gap-2 mb-8">
          ...
          <div class="relative z-10">
            <div class="flex justify-between items-start">
              ...
              <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-amber-500 font-medium"><?= htmlspecialchars($journal["status"]) ?></span>
              </div>
            </div>
            ...
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-2">
                ...
                <span class="text-slate-600 text-sm"><?= htmlspecialchars($journal["year_of_end"]) ?></span>
              </div>

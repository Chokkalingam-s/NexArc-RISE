<section class="grid lg:grid-cols-2 gap-8 p-8 min-h-[80vh] relative overflow-hidden">
  ...
  <div class="space-y-6 relative z-10">
      <div class="flex items-center gap-4 mb-8">
          ...
          <h2 class="font-bold gradient_text">
              Conferences
          </h2>
      </div>
      ...
      <div class="space-y-4">
        <?php foreach ($items as $item): ?>
          <div class="hover:scale-105 transition-all duration-500 cursor-pointer group">
            <div class="bg-white/40 rounded-xl p-6 relative overflow-hidden">
              <div class="shimmer absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div class="flex gap-4 relative z-10">
                <div class="w-14 h-14 grad_primary rounded-xl flex items-center justify-center shadow-md">
                  <span class="text-white font-bold text-lg"><?= $item[
                    "initial"
                  ] ?></span>
                </div>
                <div class="flex-1">
                  <h3 class="text-xl font-semibold gradient_text  mb-2 group-hover:text-blue-300 transition-colors">
                    <?= $item["title"] ?>
                  </h3>
                  ...
                  <div class="flex items-center gap-2 mt-3">
                    ...
                    <span class="text-xs text-blue-800 font-medium">Active</span>
                  </div>
                </div>
  ...
  <div class="space-y-6 relative z-10">
      <div class="flex items-center gap-4 mb-8">
          ...
          <h2 class="text-3xl font-bold gradient_text">
            Journals
          </h2>
      </div>
      ...
      <?php $papers = [
        [
          "title" => "Paper Title X",
          "author" => "Author Name",
          "desc" => "Brief description of the journal article.",
          "date" => "Jan 2025",
        ],
        [
          "title" => "Paper Title Y",
          "author" => "Author Name",
          "desc" => "Another short journal description.",
          "date" => "Feb 2025",
        ],
      ]; ?>
            ...
            <div class="relative z-10">
              <div class="flex justify-between items-start mb-3">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-xs text-amber-500 font-medium">Published</span>
                </div>
              </div>
              <p class="text-sm font-medium mb-3">by <?= $paper[
                "author"
              ] ?></p>
              <p class="text-sm leading-relaxed mb-4"><?= $paper[
                "desc"
              ] ?></p>
              <div class="flex justify-between items-center">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-slate-600 text-sm"><?= $paper[
                    "date"
                  ] ?></span>
                </div>
